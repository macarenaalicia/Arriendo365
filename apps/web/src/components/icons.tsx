export function IconLogoRayo() {
  return (
    <svg viewBox="0 0 48 46" aria-hidden="true">
      <defs>
        <linearGradient id="logo-rayo-gradient" x1="0" y1="0" x2="48" y2="46" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#863bff" />
          <stop offset="1" stopColor="#47bfff" />
        </linearGradient>
      </defs>
      <path
        fill="url(#logo-rayo-gradient)"
